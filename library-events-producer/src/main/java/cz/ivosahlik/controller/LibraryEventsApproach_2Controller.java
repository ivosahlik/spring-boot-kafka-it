...
import cz.ivosahlik.domain.LibraryEvent;
import cz.ivosahlik.domain.LibraryEventType;
import cz.ivosahlik.producer.LibraryEventProducer;
...
@RestController
@Slf4j
public class LibraryEventsApproach_2Controller {
    ...
    @PutMapping("/v1/libraryevent/approach2")
